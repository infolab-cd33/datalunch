...
Projet :
Idée 1 : l'accidentologie des piétons à Bordeaux
==> aucune tendance particulière ne se dégageait des données (profils victimes, lieux, horaires, etc.) + un échantillon "mortalité" insuffisant pour faire une analyse pertinente.
Idée 2 : exploration en détail la base de données pour repérer des tendances
==> mortalité des deux roues motorisés plus importante en Gironde

Sujet "Etat des lieux" : les circonstances des différents accidents, notamment la temporalité (l’heure, le jour, le mois), les conditions météorologiques, l’état des chaussées, l’âge moyen des conducteurs, etc.
...
Projet : savoir si le vin bio de Bordeaux est un marché de niche, constater quelles appellations étaient plus vertes que les autres et récolter des données de géolocalisation pour voir où se trouvait la majorité des exploitations bio. Puis, comparer ces surfaces viticoles bio avec celles des grandes régions viticoles de France.
